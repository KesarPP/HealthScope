...
function HealthScope() {
  ...
  const [activeSection, setActiveSection] = useState<'dashboard' | 'vitals' | 'mood' | 'emergency' | 'chat' | 'reports'>('dashboard');
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Card className="health-card-shadow">
                  <CardHeader className="text-center">
                    ...
                    <p className="text-gray-600">View your health tracking history</p>
                  </CardHeader>
                  <CardContent>
                    <div className="text-sm text-gray-600">
                      {vitalsHistory.length > 0 ? (
                        <p>{vitalsHistory.length} vitals recorded</p>
                      ) : (
                        <p>No activity yet</p>
                      )}
                    </div>
